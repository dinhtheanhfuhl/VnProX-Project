...
<html>
    <head>
        ...
        <link href="${pageContext.request.contextPath}/css/accountinfo.css" rel="stylesheet" type="text/css"/>
    </head>
    <body id="bgpage">
        <div id="header">
            <jsp:include page="../common/header.jsp" /></div>
        <div id="sidebarpos">
                        ...
                        <form id="submitForm" action="#" method="post">  
                            ...
                            <table>
                                ...
                                <tr>
                                    <td><p>Email</p></td>
                                    <td><div class="form-group required">  
                                            <input type="email" class="form-control"  id="email" required="" name="email" value="" oninvalid="this.setCustomValidity('Vui lòng nhập đúng định dạng email');" onchange="try{setCustomValidity('');}catch(e){};">  
                                        </div> </td>
