                ...
                <div class="row">
                    ...
                    <div class="col">
                        <form id="searchpos" action="/form/submit" method="GET"> 
                            <input type="text" name="text" class="search" placeholder="Nhập từ khoá tìm kiếm">
                            <button id="searchcolor" type="submit" name="submit" class="submit" value="Search"><i class="fa fa-search"></i></button>
                        </form>
                    </div>
