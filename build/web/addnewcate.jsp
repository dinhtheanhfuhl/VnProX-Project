...
<html>
    <head>
        ...
        <title>Tạo mới danh mục sản phẩm</title>
    ...
    <body id="bg">
        ...
        <div id="navbar">
            ...
            <p id="arrow">></p>
            <a id="producttext" href="#">Tạo mới danh mục sản phẩm</a>
        </div>
        <div id="tablecate" class="container">
            <h4 id="allcate">Tạo mới danh mục sản phẩm</h4>
            <table class="table">
                <tbody>
                    <tr>
                    ...
                    <tr>
                        <td>Danh mục sản phẩm cấp 2</td>
                        <td><input id="level" placeholder="Nhập danh mục sản phẩm, ví dụ: Thực phẩm" type="text"></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td>Danh mục sản phẩm cấp 3</td>
                        <td><input id="level" placeholder="Nhập danh mục sản phẩm, ví dụ: Thực phẩm" type="text"></td>
                        <td>
                            <button id="btnadd">
