...
<html>
    <head>
        ...
        <title>Chỉnh sửa sp khi đã lên sàn</title>
    ...
    <body id="bgpage">
        ...
        <div id="contentpos">
            ...
            <form id="form" method="post">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <div id="addimage2">
                                    <p id="iconplus" onclick="document.getElementById('getFile1').click()"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
                                        <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                                        <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
                                        </svg>
                                    </p>
                                    <input type="file" id="getFile1" />
                                    <img width="80px" height="80px" id="preview1" />
                                </div>
                                <div id="addimage3">
                                    <p id="iconplus" onclick="document.getElementById('getFile2').click()"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
                                        <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                                        <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
                                        </svg>
                                    </p>
                                    <input type="file" id="getFile2" />
                                    <img width="80px" height="80px" id="preview2" />
                                </div>
                                <div id="addimage4">
                                    <p id="iconplus" onclick="document.getElementById('getFile3').click()"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
                                        <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                                        <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
                                        </svg>
                                    </p>
                                    <input type="file" id="getFile3" />
                                    <img width="80px" height="80px" id="preview3" />
                                </div>
                                <div id="addimage5">
                                    <p id="iconplus" onclick="document.getElementById('getFile4').click()"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
                                        <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                                        <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
                                        </svg>
                                    </p>
                                    <input type="file" id="getFile4" />
                                    <img width="80px" height="80px" id="preview4" />
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="form-control" required="" placeholder="1234567890123" id="barcode"  name="barcode" value=""> 
                        </tr>
                        <tr>
                            <td><p id="licen">Giấy tờ chứng nhận</p></td>
                            <td><div id="licence" class="form-group required">
                                    <p id="filetext" onclick="document.getElementById('myfile').click()"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
                                        <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                                        <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
                                        </svg> Giấy tờ chứng nhận 
                                    </p>
                                    <input type="file" id="myfile" name="myfile" accept=".doc,.docx,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document">
                                </div> 
                            </td>
                        </tr>
                        <tr>
                ...
                <table id="tb3">
                    ...
                    <tbody>
                        <tr >
                            ...
                            <td><input id="numberfrom" type="text" class="form-control" required="" value=""> </td>
                            <td id="price" ><input type="text" id="p" class="form-control" required="" value=""> </td>
                        </tr>
                        <tr id="as">
                            <td></td>
                            <td></td>
                        ...
                        <tr>
                            <td></td>
                            <td></td>
                            <td><input type="text" class="form-control" required="" value=""> </td>
                            <td id="price" ><input id="p" type="text" class="form-control" required="" value=""> </td>
                        </tr>
                        <tr id="as">
                            <td></td>
                            <td></td>
                        ...
                        <tr>
                            <td></td>
                            <td></td>
                            <td style="cursor: pointer" onclick="myFunction()" id="addnew"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
                                <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                                <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
                                </svg> <a>Thêm khoảng giá mới</a></td>
                            <td></td>
                        </tr>
                    </tbody>
                </table>
                ...
                <div class="form-group pt-1">  
                    <button id="save" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" type="submit"> Lưu chỉnh sửa </button> </div>
            </form>
        </div>
        <script>
            ...
            const fileEle1 = document.getElementById('getFile1');
            const previewEle1 = document.getElementById('preview1');
            fileEle1.addEventListener('change', function (e) {
                // Get the selected file
                const file = e.target.files[0];
                ...
                reader.addEventListener('load', function () {
                    // Set the source for preview element
                    previewEle1.src = reader.result;
                });

                reader.readAsDataURL(file);
            });
            const fileEle2 = document.getElementById('getFile2');
            const previewEle2 = document.getElementById('preview2');
            fileEle2.addEventListener('change', function (e) {
                ...
                reader.addEventListener('load', function () {
                    // Set the source for preview element
                    previewEle2.src = reader.result;
                });

                reader.readAsDataURL(file);
            });
            const fileEle3 = document.getElementById('getFile3');
            const previewEle3 = document.getElementById('preview3');
            fileEle3.addEventListener('change', function (e) {
                ...
                reader.addEventListener('load', function () {
                    // Set the source for preview element
                    previewEle3.src = reader.result;
                });

                reader.readAsDataURL(file);
            });
            const fileEle4 = document.getElementById('getFile4');
            const previewEle4 = document.getElementById('preview4');
            fileEle4.addEventListener('change', function (e) {
                // Get the selected file
                const file = e.target.files[0];
