...
<html>
    ...
    <body id="bgpage">
        ...
        <p id="basicinfor">Thông tin cơ bản</p>
        <div id="contentpos">
            <div id="note">
                <p id="licennote" >
            ...
            <form id="form" method="post">
                ...
                <table id="tb2">
                    ...
                    <tr>
                        ...
                        <td><p id="texttpro">Ngày thu hoạch</p></td>
                        <td><div id="inputform2" class="form-group required">  
                                <input type="date" class="form-control" placeholder="Nhập ngày thu hoạch" id="havertday" required="" name="havertday" value="">
                            </div></td>
                    </tr>
                    <tr>
                        ...
                        <td><p id="texttpro">Ngày hết hạn</p></td>
                        <td><div id="inputform2" class="form-group required">  
                                <input type="date" class="form-control" placeholder="Nhập ngày hết hạn" id="dateexpired" required="" name="dateexpirate" value="">
                            </div></td>
                    </tr>
                </table>
